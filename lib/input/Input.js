  ...
  var Input = function (_React$Component) {
    ...
    _createClass(Input, [{
      ...
      value: function render() {
        ...
        var labelClassName = (0, _classnames5.default)('primaryInputLabel', theme.label, _defineProperty({}, theme.fixed, !floating));
        ...
        var inputElementProps = _extends({}, others, {
          className: (0, _classnames5.default)(theme.inputElement, _defineProperty({}, theme.filled, valuePresent), 'primaryInput'),
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement('span', { className: (0, _classnames5.default)('primaryInputUnderline', theme.bar) }),
