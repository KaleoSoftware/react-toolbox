...
var factory = function factory(ripple, FontIcon) {
    ...
    _createClass(Button, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            secondaryButton = _props.secondaryButton,
            theme = _props.theme,
            type = _props.type,
            raised = _props.raised,
            others = _objectWithoutProperties(_props, ['accent', 'children', 'className', 'flat', 'floating', 'href', 'icon', 'inverse', 'label', 'mini', 'neutral', 'primary', 'primaryButton', 'secondaryButton', 'theme', 'type', 'raised']);

        var element = href ? 'a' : 'button';
        var level = primary ? 'primary' : accent ? 'accent' : 'neutral';
        var shape = flat ? 'flat' : raised ? 'raised' : floating ? 'floating' : 'flat';

        var classes = (0, _classnames3.default)(theme.button, [theme[shape]], (_classnames = {}, _defineProperty(_classnames, theme[level], neutral), _defineProperty(_classnames, theme.mini, mini), _defineProperty(_classnames, theme.inverse, inverse), _classnames), className, primaryButton && 'primaryButton', secondaryButton && 'secondaryButton');
  ...
  Button.propTypes = {
    ...
    primaryButton: _react.PropTypes.bool,
    raised: _react.PropTypes.bool,
    secondaryButton: _react.PropTypes.bool,
